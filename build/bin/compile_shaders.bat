...
dred -f file2chex ..\..\examples\resources\01_Triangle\01_Triangle.vert.spirv -n g_VertexShaderData > 01_Triangle.vert.c
...
dred -f file2chex ..\..\examples\resources\01_Triangle\01_Triangle.frag.spirv -n g_FragmentShaderData > 01_Triangle.frag.c